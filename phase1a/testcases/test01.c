...
int testcase_main()
{
    ...
    USLOSS_Console("Phase 1B TEMPORARY HACK: Manually switching to the first XXp1()\n");
    TEMP_switchTo(pid1);
    ...
    USLOSS_Console("Phase 1B TEMPORARY HACK: Manually switching to the second XXp1()\n");
    TEMP_switchTo(pid2);
    kidpid = join(&status);
